...
QVariant
DefsTableUtils::GetItemVariant( StateNode::KeyValueProp* kvElement)
{
    int emptyType = -1;
...
QString
DefsTableUtils::FormatKeyValueString( const StateNode::KeyValueProp kvElement, bool isolateValue)
{
    QString tableString = "";
